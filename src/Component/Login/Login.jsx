...
<div className="rightSide">
    ...
    <div className="inputs">
      <div className="row">
        ...
        <div className="col-4 ">
          <input className="input1" onChange={getData}  name="email" type="email" placeholder="UserEmail@gmail.com" />
        </div>
        <div className="col-4 ">
  ...
  <     path d="M18 0H2C0.9 0 0.00999999 0.9 0.00999999 2L0 14C0 15.1 0.9 16 2 16H18C19.1 16 20 15.1 20 14V2C20 0.9 19.1 0 18 0ZM18 4L10 9L2 4V2L10 7L18 2V4Z" fill="#0D4C92"/>
    ...
    <div className="inputs ">
      <div className="row">
        ...
        <div className="col-4">
          <input className="in" type="password"  onChange={getData} name="password" placeholder="................." />
        </div>
        <div className="col-4">
