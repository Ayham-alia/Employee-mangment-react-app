...
export default function Dashboard(props) {
  ...
  //Sreach for Employees
  const SearchEmployee = (e) => {
    let { value } = e.target;
    const arr = [];
    props.employees.map((emp) => {
      if(emp.fullName.toLowerCase().includes(value.toLowerCase())){
      arr.push(emp);
    } 
    setEmps(arr);
    })
  ...
  async function checkIn(employeeId){
    try{
      ...
      if(e.response.data.message!=="validation error"){
        ...
        Swal.fire({
          text: e.response.data.validationArray[0][0].message,
          icon: 'error',
          customClass: {
            title: 'my-custom-title',
            confirmButton: 'my-custom-button',
      ...
      <div className='d-flex overflow-x-hidden'>
        ...
        <div className="DashSide">
          ...
          <div className="mainDashboard">
            ...
            <div className="DashContent">
              <div className="input-container d-flex">
                <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                  <path d="M18.031 16.617L22.314 20.899L20.899 22.314L16.617 18.031C15.0237 19.3082 13.042 20.0029 11 20C6.032 20 2 15.968 2 11C2 6.032 6.032 2 11 2C15.968 2 20 6.032 20 11C20.0029 13.042 19.3082 15.0237 18.031 16.617Z" />
                </svg>
                      ...
                      <tr key={emp._id}>
                        ...
                        <td>
                          <div className="Actions">
                            ...
                            <button type="button ms-2" className="delete ms-1" onClick={()=>DeleteEmployee(emp._id)}><svg xmlns="http://www.w3.org/2000/svg" width={26} height={24} viewBox="0 0 26 24" fill="none">
            ...
            <Pagination handlePageChange={props.handlePageChange} PagesCount={props.TotalPages} />
          </div>
        </div>
      </div>
